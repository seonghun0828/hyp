...
export default function ExpressionsPage() {
  ...
  const t = useTranslations('styles.visuals');
  ...
  const handleSelect = (optionId: string) => {
    ...
    router.push(`/${locale}/styles/tones-moods`);
  };
  ...
  if (!summary || !styles?.messageType) {
    return null;
  }

  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 to-indigo-100">
      <ProgressBar currentStep={4} totalSteps={10} stepNames={stepNames} />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {visualStyles.map((option) => {
              ...
              // photo-realistic -> photoRealistic (카멜케이스 변환)
